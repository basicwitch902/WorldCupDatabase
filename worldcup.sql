...
--
-- Name: games fk_oppid; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.games
    ADD CONSTRAINT fk_oppid FOREIGN KEY (opponent_id) REFERENCES public.teams(team_id);


--
-- Name: games fk_winid; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.games
    ADD CONSTRAINT fk_winid FOREIGN KEY (winner_id) REFERENCES public.teams(team_id);
